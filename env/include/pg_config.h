...
#define CONFIGURE_ARGS " '--prefix=/Users/saianand/Documents/sample-ml-project/env' '--with-readline' '--with-libraries=/Users/saianand/Documents/sample-ml-project/env/lib' '--with-includes=/Users/saianand/Documents/sample-ml-project/env/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/Users/saianand/Documents/sample-ml-project/env/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=arm64-apple-darwin20.0.0' 'host_alias=arm64-apple-darwin20.0.0' 'CC=arm64-apple-darwin20.0.0-clang' 'CFLAGS=-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/saianand/Documents/sample-ml-project/env/include -fdebug-prefix-map=/var/folders/k1/30mswbxs7r1g6zwn8y4fyt500000gp/T/abs_61nlzg8ism/croot/postgresql-split_1741123574738/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/Users/saianand/Documents/sample-ml-project/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/saianand/Documents/sample-ml-project/env/lib -L/Users/saianand/Documents/sample-ml-project/env/lib' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 -isystem /Users/saianand/Documents/sample-ml-project/env/include -mmacosx-version-min=11.1' 'CXX=' 'CLANG=arm64-apple-darwin20.0.0-clang' 'PKG_CONFIG_PATH=/Users/saianand/Documents/sample-ml-project/env/lib/pkgconfig'"
